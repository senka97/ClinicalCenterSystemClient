...
export class HpDoctorComponent implements OnInit {
  ...
  constructor(private _patientService: PatientService,private _authService: AuthService,private _absenceService:AbsenceService, private _dialog: MatDialog, private _calendar: NgbCalendar) {
